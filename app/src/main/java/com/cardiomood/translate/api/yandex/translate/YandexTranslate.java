package com.cardiomood.translate.api.yandex.translate;
...
public class YandexTranslate {
    ...
    private static final String SERVICE_END_POINT = "https://com.cardiomood.translate.yandex.net/api/v1.5/tr.json";
